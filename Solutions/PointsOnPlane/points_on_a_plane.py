...
def init_u_agent(state_shape, action_shape, action_max, batch_size):
    ...
    noise = OUNoise(2, threshold=action_max, threshold_min=0.001, threshold_decrease=0.001 * action_max)
    agent = NAFAgent(mu_model, p_model, v_model, noise, state_shape, action_shape, action_max, batch_size, gamma=0.9999)
    return agent
...
if __name__ == '__main__':
    ...
    rewards = resolver.fit_agents(env, episode_n, u_agent, v_agent, fit_step=2)
