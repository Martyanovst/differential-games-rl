...
class Q_model(nn.Module):
    def __init__(self, v_model, action_shape, beta, g, q, dt, action_max=1):
        super().__init__()
        self.v = v_model
        self.beta = beta
        self.g = g
...
class Sphere_R_G_NAF:

    def __init__(self, v_model,
                 noise, state_shape, action_shape, beta, g, q, dt,
                 action_max, batch_size=200, gamma=0.9999):
        self.state_shape = state_shape
        self.action_shape = action_shape
        self.action_max = action_max

        self.Q = Q_model(v_model, action_shape, beta, g, q, dt, action_max)
