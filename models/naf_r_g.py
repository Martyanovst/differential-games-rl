...
class Q_model(nn.Module):
    def __init__(self, v_model, action_shape, dt, r=1, g=1, action_max=1):
        super().__init__()
        self.v = v_model
        self.dt = dt
        self.r = r
...
class NAF_R_G:
    ...
    def __init__(self, v_model,
        ...
        self.Q = Q_model(v_model, action_shape, dt, r, g, action_max)
